...
import { ref, StorageReference, uploadBytesResumable, getDownloadURL, getMetadata, deleteObject, FullMetadata } from 'firebase/storage'
...
export class StoragedFileComponent implements AfterViewInit {
    ...
    /** */
    ngAfterViewInit() {
        this.storageRef = ref(this.fileService.storage, `${this.filePath}/${this.fileName}`)
        this.fileLoad()
    }
    //#endregion
    //#region Methods
